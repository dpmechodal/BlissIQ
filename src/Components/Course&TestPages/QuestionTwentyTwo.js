              ...
              <div className="QuestionTwentyTwo-bg">
                <div className="QuestionTwentyTwo-heading">
                  ...
                  <p className="QuestionTwentyTwo-p">
                    ...
                    while watching over the village sheep. He wanted to make
                    things more exciting. So, he yelled out that{" "}
                    <span className="twenty-two-color-two">he saw a wolf</span>{" "}
                    chasing the sheep.
                  </p>
                </div>
...
export default QuestionTwentyTwo;
